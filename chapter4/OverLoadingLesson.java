...
public class OverLoadingLesson {
    ...
    public static void main(String[] args) {
        ...
        short s = 1;
        oll.fly();
        oll.fly(s); // Overloading is determined at compile time, so the method with the short parameter is called.
        ...
        try{
            ...
            System.out.println("oll.fly((short)1,1) has been caught.");
        }
    }
}
